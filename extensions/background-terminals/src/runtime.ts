 ...
 * disposeAll → each owned launched process group is terminated; Windows uses
 * taskkill /T). Commands that detach into a new session are outside this
 * ownership boundary and are prohibited by the tool contract.
 */
